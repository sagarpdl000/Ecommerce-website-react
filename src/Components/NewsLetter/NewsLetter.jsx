...
const NewsLetter = () => {
  return (
    <div className='bg-gradient-to-b from-slate-200 to-stone-200 my-20 py-16 grid grid-cols-1 font-poppins'>
        <div className='text-center'>
            ...
            <button className='bg-black text-white py-2 px-6 rounded-2xl'>Subscribe</button>
        </div>
    </div>
  )
}
