  ...
  return (
    ...
    <div className=' h-screen w-full bg-gray-200 flex flex-col justify-center items-center font-poppins'>
      ...
      <div className=' bg-white  px-6 py-6 '>
        ...
        <div>
          <button  className='border-2 py-2 my-3 text-center bg-blue-500 w-full'>Continue</button>
        </div>

        
          <p className='my-3'>Already have an account? <span className='text-blue-700'><Link to = ''>Login here</Link></span></p>
